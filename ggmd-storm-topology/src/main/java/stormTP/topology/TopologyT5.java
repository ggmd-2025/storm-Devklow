...
public class TopologyT5 {
	...
	public static void main(String[] args) throws Exception {
        ...
        builder.setBolt("speedBolt", new SpeedBolt(), nbExecutors).shuffleGrouping("masterStream");
        /*Affectation à la topologie du bolt qui émet le flux de sortie, il prendra en input le bolt nofilter*/
        builder.setBolt("exit", new ExitBolt4(portOUTPUT), nbExecutors).shuffleGrouping("speedBolt");
